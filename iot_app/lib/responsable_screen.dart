...
class _ResponsablePageState extends State<ResponsablePage> {
  List<Map<String, dynamic>> complaints = [
    {
      'id': 1,
      'date': '2023-10-01',
      'message': 'Produit ne fonctionne pas correctement.',
      'response': '',
      'status': 'Ouvert'
    },
    {
    ...
    },
    {
      'id': 3,
      'date': '2023-10-10',
      'message': 'Mauvais service client.',
      'response': '',
      'status': 'Ouvert'
    }
  ];

  String selectedDate = 'Tous';
  String searchQuery = '';
  ...
  void _respondToComplaint(int id, String response) {
    ...
    Future.delayed(Duration(seconds: 2), () {
      setState(() {
        complaints.firstWhere(
            (complaint) => complaint['id'] == id)['response'] = response;
        isLoading = false;
      });
  ...
  void _markAsResolved(int id) {
    ...
    Fluttertoast.showToast(
      msg: "Plainte marquée comme résolue !",
      toastLength: Toast.LENGTH_SHORT,
      gravity: ToastGravity.BOTTOM,
  ...
  List<Map<String, dynamic>> get filteredComplaints {
    return complaints.where((complaint) {
      bool matchesDate =
          selectedDate == 'Tous' || complaint['date'] == selectedDate;
      bool matchesSearch = complaint['message']
          .toLowerCase()
          ...
          Padding(
            ...
            child: TextField(
              decoration: InputDecoration(
                hintText: 'Rechercher des plaintes...',
